...
\usepackage[
    pdftitle={Pito Salas's CV},
    pdfauthor={Pito Salas},
...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Pito Salas - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Arlington, MA 02474}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:rpsalas@brandeis.edu}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}rpsalas@brandeis.edu}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+1-617-388-6367}{{\footnotesize\faPhone*}\hspace*{0.13cm}(617) 388-6367}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://salas.com/}{{\footnotesize\faLink}\hspace*{0.13cm}salas.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/pitosalas}{{\footnotesize\faLinkedinIn}\hspace*{0.13cm}pitosalas}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://github.com/pitosalas}{{\footnotesize\faGithub}\hspace*{0.13cm}pitosalas}}%
    \end{header}
